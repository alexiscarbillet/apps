...
class LandingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Organize hardware into focused tracks for progressive study.
    final List<Map<String, dynamic>> categoryConfigs = [
      {
        'name': 'Hardware Foundations',
        'description': 'Build a broad mental model of the main hardware subsystems.',
        'icon': Icons.memory_outlined,
        'gradient': [const Color(0xFF64748B), const Color(0xFF334155)],
      },
      {
        'name': 'CPU Architecture',
        'description': 'Instruction execution, caches, pipelines, and multicore design.',
        'icon': Icons.developer_board_outlined,
        'gradient': [const Color(0xFF0EA5E9), const Color(0xFF2563EB)],
      },
      {
        'name': 'Memory Systems',
        'description': 'RAM technologies, channels, refresh, and error correction.',
        'icon': Icons.memory_rounded,
        'gradient': [const Color(0xFF14B8A6), const Color(0xFF0F766E)],
      },
      {
        'name': 'Storage & I/O',
        'description': 'SSDs, HDDs, NVMe, PCIe lanes, USB, and RAID.',
        'icon': Icons.storage_rounded,
        'gradient': [const Color(0xFFF97316), const Color(0xFFDC2626)],
      },
      {
        'name': 'Motherboards & Components',
        'description': 'Chipsets, firmware, expansion, security, and connectivity.',
        'icon': Icons.account_tree_outlined,
        'gradient': [const Color(0xFFA855F7), const Color(0xFF7C3AED)],
      },
      {
        'name': 'Power & Thermals',
        'description': 'PSUs, VRMs, cooling, thermal limits, and performance tuning.',
        'icon': Icons.thermostat_outlined,
        'gradient': [const Color(0xFFEAB308), const Color(0xFFEA580C)],
      },
    ];
                ...
                background: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Build strong foundations in computer hardware, from silicon to storage.',
