...
final List<Question> wiringCanadianQuestions = [
  Question(
  ...
  Question(
    ...
    correctAnswerIndex: 2,
    explanation: 'Resistance is measured in Ohms (Î©), named after Georg Simon Ohm. "Volt" is the unit of electrical potential difference (voltage). "Ampere" is the unit of electrical current. "Watt" is the unit of electrical power.',
  ),
  Question(
  ...
  Question(
    questionText: 'What document forms the basis for electrical installation rules in Canada?',
    options: ['The Canadian Electrical Code, CSA C22.1', 'The Criminal Code', 'The National Building Code only', 'The IEEE Ethernet standard'],
    correctAnswerIndex: 0,
    explanation: 'The Canadian Electrical Code, CSA C22.1, is the primary technical reference for electrical installations. Provinces and territories adopt and enforce electrical rules through their own legislation, regulations, permits, and authorities having jurisdiction, so the locally adopted edition and requirements must be checked.',
  ),
  Question(
    questionText: 'Which Canadian cable type is commonly used for concealed residential branch-circuit wiring?',
    options: ['NMD90', 'TECK90 only', 'Coaxial RG-6', 'Speaker wire'],
    correctAnswerIndex: 0,
    explanation: 'NMD90 is a common non-metallic sheathed cable used for many concealed residential branch circuits where permitted. TECK90 is an armoured industrial or commercial cable, RG-6 is coaxial cable, and speaker wire is not a substitute for approved branch-circuit wiring.',
  ),
  Question(
    questionText: 'What is RW90 wire designed to provide?',
    options: ['A recognized insulated conductor rating for wet or dry locations when installed as permitted', 'A replacement for every type of cable assembly', 'Only low-voltage audio transmission', 'A communication protocol for smart meters'],
    correctAnswerIndex: 0,
    explanation: 'RW90 is an insulated conductor type with a 90 C rating under specified conditions and is commonly used in raceways and other approved installations. Its use still depends on the installation method, environment, conductor size, and locally adopted code requirements.',
  ),
  Question(
    questionText: 'In common Canadian branch-circuit wiring, which conductor is normally identified as the grounded conductor?',
    options: ['White or gray', 'Green or bare', 'Red only', 'Orange only'],
    correctAnswerIndex: 0,
    explanation: 'White or gray commonly identifies the grounded (neutral) conductor. Green or bare identifies bonding or grounding conductors, while black and red are commonly ungrounded conductors in many wiring systems. Identification rules and exceptions must be checked against the applicable code and installation.',
  ),
  Question(
    questionText: 'What is the primary purpose of a bonding conductor?',
    options: ['Provide a low-impedance fault path so protective devices can operate', 'Increase normal circuit voltage', 'Carry the normal neutral load in every circuit', 'Replace overcurrent protection'],
    correctAnswerIndex: 0,
    explanation: 'Bonding connects normally non-current-carrying metal parts so a fault has a low-impedance path back to the source and protective devices can disconnect the circuit. Bonding is not a replacement for overcurrent protection and should not be used as the normal load return path.',
  ),
  Question(
    questionText: 'What does ampacity describe for an electrical conductor?',
    options: ['The maximum current it can carry continuously under specified conditions', 'Its insulation color', 'Its physical length only', 'The voltage supplied by the utility'],
    correctAnswerIndex: 0,
    explanation: 'Ampacity is the allowable current capacity of a conductor under specified conditions. Conductor material and size, insulation temperature rating, ambient temperature, number of current-carrying conductors, installation method, and code rules can all affect the permitted value.',
  ),
  Question(
    questionText: 'What is the role of a GFCI device?',
    options: ['Disconnect power when it detects an imbalance suggesting leakage current', 'Increase the available fault current', 'Regulate the frequency of utility power', 'Replace every circuit breaker'],
    correctAnswerIndex: 0,
    explanation: 'A ground-fault circuit interrupter compares current leaving and returning through the circuit and disconnects when an imbalance suggests leakage. It provides shock protection in many locations but does not replace all overcurrent or arc-fault protection requirements.',
  ),
  Question(
    questionText: 'What hazard is an AFCI intended to reduce?',
    options: ['Fires caused by unintended arcing', 'Low battery voltage', 'Transformer hum', 'Excessive water pressure'],
    correctAnswerIndex: 0,
    explanation: 'An arc-fault circuit interrupter detects patterns associated with dangerous arcing and can disconnect the circuit to reduce fire risk. AFCI and GFCI devices address different hazards and may both be relevant depending on the installation.',
  ),
  Question(
    questionText: 'Why must a wire type be selected for the installation environment?',
    options: ['Insulation and cable construction must withstand conditions such as heat, moisture, chemicals, and physical damage', 'All wires have identical ratings once painted', 'Only the conductor color changes with the environment', 'Environment affects voltage but never insulation'],
    correctAnswerIndex: 0,
    explanation: 'Cable and conductor ratings depend on the environment and installation method. Moisture, heat, sunlight, chemicals, movement, and physical damage can require different insulation, jackets, raceways, or cable types. Product markings and the locally adopted code determine whether a wiring method is permitted.',
  ),
];
