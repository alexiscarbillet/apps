...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget _buildResultsView() {
    ...
    // Performance assessment for finance
    String title;
    String subtitle;
    IconData rankIcon;
    Color rankColor;
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Row(
                children: [
                  Icon(Icons.analytics_outlined, color: Color(0xFF10B981), size: 20),
                  SizedBox(width: 8),
                  Text(
                    'Review and Learn',
                    style: TextStyle(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ...List.generate(question.options.length, (optIdx) {
                                    ...
                                    if (isOptionCorrect) {
                                      itemColor = const Color(0xFF065F46).withValues(alpha: 0.5);
                                      ...
                                      itemColor = const Color(0xFF881337).withValues(alpha: 0.5);
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (_isAnswered) {
                      ...
                      if (isCorrect) {
                        itemColor = const Color(0xFF065F46); // Green success
                        borderSide = const BorderSide(color: Color(0xFF10B981), width: 1.5);
                        feedbackIcon = const Icon(Icons.check_circle_rounded, color: Color(0xFF10B981), size: 20);
                      } else if (isUserChoice) {
                        itemColor = const Color(0xFF881337); // Red wrong
