...
public class NotificationWorker extends Worker {
    ...
    private void sendNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel("MotDuJourChannel", "Mot du jour", NotificationManager.IMPORTANCE_DEFAULT);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "MotDuJourChannel")
                .setSmallIcon(R.mipmap.logo)
                .setContentTitle("Mot du jour: " + word)
